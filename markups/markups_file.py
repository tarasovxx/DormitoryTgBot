...
#creating promocode_btn
promocode_btn = KeyboardButton("💯 Промокод")

#creating order menu 
basket_markup = ReplyKeyboardMarkup(resize_keyboard = True, row_width=2).add(basket_remove_btn, promocode_btn, menu_btn, choose_game, buy_btn)
